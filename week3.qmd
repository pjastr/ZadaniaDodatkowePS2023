---
title: "Zadania dodatkowe - Programowanie Strukturalne - Tydzień 3"
lang: pl
editor: visual
format: gfm
---
...
Napisz program, który pobiera od użytkownika liczbę całkowitą $n$. Program sprawdza i wyświetla informację, czy wprowadzona liczba $n$ jest palindromem czy nie. Definicja palindromu <https://pl.wikipedia.org/wiki/Palindrom>
...
Napisz program, który wyświetla na konsoli sumę liczb nieparzystych od 11 do 67. W programie wykorzystaj samodzielnie napisaną funkcję rekurencyjną.

## WEEK3 TASK3

Napisz program, który zsumuje liczby całkowite od 1 do 100. W kodzie źródłowym nie wykorzystuj symbolu plusa (jako dodawanie, inkrementacja i inne zastosowania).
